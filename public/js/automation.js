    ...
    <div class="auto-card">
      ...
      <div style="padding:18px 20px 20px;display:flex;flex-direction:column;gap:16px">
        ...
        <div style="display:flex;flex-direction:column;gap:5px">
          ...
          <span style="font-family:var(--h-sans);font-size:12px;color:var(--h-ink-faint)">Used for reading messages and posting replies</span>
        </div>
...
async function autoDoSlackConnect() {
  ...
  if (!appToken || !botToken) { showToast('Both tokens are required', { error: true }); return; }
